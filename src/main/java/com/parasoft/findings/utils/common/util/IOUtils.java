...
public final class IOUtils {
    ...
    public static void close(final InputStream in) {
        ...
        } catch (IOException ioe) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during closing input stream don't cause the build to fail."
    ...
    public static void close(final OutputStream out)
    {
        ...
        } catch (IOException ex) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during closing output stream don't cause the build to fail."
    ...
    public static void close(final Reader in) {
        ...
        } catch (IOException ex) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during closing input stream don't cause the build to fail."
