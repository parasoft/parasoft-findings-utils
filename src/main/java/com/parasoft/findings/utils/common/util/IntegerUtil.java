...
public final class IntegerUtil {
    ...
    public static int parseInt(String sValue, int defaultValue) {
        ...
        } catch (Exception exc) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during int value parsing don't cause the process to fail."
