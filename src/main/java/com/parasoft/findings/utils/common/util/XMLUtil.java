...
public final class XMLUtil {
    ...
    private static void configureReader(XMLReader reader, boolean disableDTD, boolean disableExternalEntities) {
        ...
        } catch (SAXException e) { // parasoft-suppress OWASP2021.A5.NCE "This is intentionally designed to ensure the SAX exceptions during reader configuration don't cause the process to fail."
