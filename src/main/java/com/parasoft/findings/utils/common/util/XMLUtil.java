...
public final class XMLUtil {
    ...
    public static SAXParserFactory getSaxParserFactory() {
        if (_saxParserFactory == null) {
            ...
            } catch (FactoryConfigurationError err) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during SAX parser factory obtaining don't cause the process to fail."
    ...
    public static int getInt(final String sKey, final int defaultValue, final Map map) {
        ...
        } catch (NumberFormatException e) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during int value obtaining don't cause the process to fail."
