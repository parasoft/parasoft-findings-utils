...
public final class MessageResourceBundle {
    ...
    private static void loadImpl(String sBundleName, IntlResourceProvider loader, MessageBundleProperties properties) {
        ...
        for (InputStream input : resources) {
            ...
            } catch (IOException ioe) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during resources loading don't cause the process to fail."
    ...
    private static void findMissing(String sBundleName, Map<String, Field> fieldMap, Field[] aFields, boolean bIsAccessible) {
        for (Field field : aFields) {
            ...
            } catch (Exception exc) {  // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during message value setting don't cause the process to fail."
