...
public class RuleDocumentationProvider {
    ...
    private RulesRestClient getRulesRestClient() {
        ...
        } catch (DtpUrlException e) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during rules rest client obtaining don't cause the process to fail."
        ...
        } catch (NotSupportedDtpVersionException e) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during rules rest client obtaining don't cause the process to fail."
        ...
        } catch (Exception e) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during rules rest client obtaining don't cause the process to fail."
