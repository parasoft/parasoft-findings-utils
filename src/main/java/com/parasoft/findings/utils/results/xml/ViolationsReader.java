...
public class ViolationsReader
    ...
    public void startElement(String sUri, String sLocalName, String sQName, Attributes attributes)
        ...
        if (_currentReader != null) {
            ...
            } catch (Throwable t) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during reading violations processing don't cause the build to fail."
    ...
    private void addViolation() {
        ...
        } catch (Throwable t) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during adding violations don't cause the build to fail."
