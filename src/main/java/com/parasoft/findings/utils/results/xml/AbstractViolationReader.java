...
public abstract class AbstractViolationReader
    ...
    private IViolation createViolation() {
        ...
        } catch (LocationsException le) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during reading violation's location don't cause the build to fail."
    ...
    protected ResultLocation getLegacyLocation(Map<String, String> attributesMap, String sLocPrefix) {
        ...
        } catch (LocationsException e) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during getting legacy location don't cause the build to fail."
    ...
    private long parseLong(String sValue, long defaultValue) {
        ...
        } catch (Exception exc) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during parsing long value don't cause the build to fail."
